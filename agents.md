...
- Solution: added two temporary `USER_RULE` entries to VLAN20_MAIN interface:
  ...
  - Both placed above the existing "Block all private networks" rule for