...
```
    ...
    │  Port 4: Workstation (VLAN 1 Untagged)      │
    │  Port 5-8: Available                         │
    └───────┬──────────────────────────────────────┘
            │ Port 2 (Trunk)
            ↓
...
|--------|------------|-------------|-------------|
| Router | [ROUTER_IP] | Port 1 | Untagged |
| Switch Management | [SWITCH_IP] | N/A | VLAN 1 |
| Proxmox Host | [PROXMOX_IP] | Port 2 | Untagged (PVID 1) |
| Workstation | [WORKSTATION_IP] | Port 4 | Untagged |
...
```
Workstation → Switch (VLAN 1) → Proxmox (VLAN 1 Untagged)
...
|-------------|-------------|
| [ROUTER_IP] | Main router gateway IP |
| [SWITCH_IP] | Switch management IP |
| [PROXMOX_IP] | Proxmox server IP |
| [WORKSTATION_IP] | Workstation/Gaming PC IP |
