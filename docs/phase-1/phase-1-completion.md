...
|------------|------|--------|----------|--------|---------|
| local | Directory | 250GB SSD | 232GB | 232GB | Proxmox system, ISOs, templates |
| vmpool-fast | ZFS Mirror | 2x 1TB NVMe | 2TB | 860GB | Primary VM storage (fast, redundant) |
| vm-storage | Directory | 2TB HDD | 1.8TB | 1.8TB | Additional VM storage |
| data-storage | Directory | 8TB HDD | 7.3TB | 7.3TB | User data, backups |
...
- **Devices:** 2x WD Green SN350 1TB NVMe
...
**Snapshot Testing:**
1. Created snapshot: `clean-install`
2. Made changes (created test files)
3. Rolled back successfully
4. Rollback time: < 5 seconds ✨
...
- Backup file: `vzdump-qemu-[VM_ID]-[TIMESTAMP].vma.zst`
...
**Problem:**
- NVMe drive contained old Proxmox LVM installation
- Old volume group preventing ZFS creation
...
- ✅ ZFS mirror pool operational (860GB)
- ✅ Storage hierarchy established (10TB total)
- ✅ Network connectivity configured
- ✅ Repository sources configured

### Virtual Machines
- ✅ Ubuntu Server 22.04 VM created
- ✅ Qemu Guest Agent functional
- ✅ SSH access enabled
- ✅ System fully updated
...
- ✅ Snapshot functionality validated
...
### What Went Well
- **ZFS Implementation:** Smooth setup, instant snapshots impressive
- **Planning:** Good hardware inventory before starting saved time
- **Documentation:** Documenting as I go made troubleshooting easier
- **Community Resources:** YouTube tutorials very helpful

### What Could Be Improved
- **Hardware Testing:** Should have tested all drives before starting
- **Time Estimation:** Took longer than expected (good learning!)
- **Backup Planning:** Should have planned for drive failure upfront
...
|-------------|-------------|
| [PROXMOX_HOSTNAME] | Your Proxmox server hostname |
| [HOSTNAME] | Server hostname in commands |
| [VM_IP_ADDRESS] | IP address assigned to VM |
| [VM_ID] | Virtual machine ID number |
| [TIMESTAMP] | Backup timestamp |
| [OLD_VG_NAME] | Old LVM volume group name |
