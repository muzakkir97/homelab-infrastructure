...
**Symptoms:** Documentation contains stale or hallucinated information; ROADMAP.md shows archived phases as active, current-state.md lists wrong hardware specs, agents.md shows deployed agents as Planned

**Root Cause:** Da Vinci hallucinated hardware specs (EPYC 5645/256GB RAM, RTX 4070) from a January 2026 hypothetical "dream homelab" discussion without context flags. May 10, 2026 decision to retire Homepage and archive phases 22.8C/22.8D/22.8E/22.15/22.16 never propagated to ROADMAP.md — Da Vinci lacked explicit REPLACE SECTION instruction. April 27, 2026 MERLIN and Midas deployments marked incorrectly as Planned (0/4) instead of Active (2/4). Knowledge Indexer folder lists were completely hallucinated (01-inbox through 13-archive) and did not match actual vault structure (00-inbox through 11-reference plus new folders 04-personal, 08-agents, 09-people, 10-projects).
